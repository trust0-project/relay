export default {
    ...
    plugins: [
      ...
      ['@semantic-release/exec', { "prepareCmd": 'docker build . -t trust0/relay:V${nextRelease.version}'}],
      ['@semantic-release/exec', { "prepareCmd": 'docker push trust0/relay:V${nextRelease.version}'}],
      ['@semantic-release/exec', { "prepareCmd": 'docker push trust0/relay:latest'}],
      [
